...
/-! C05 source, UNBUILT. No essentiality hypothesis. -/
...
theorem Representation.exists_path_state_approx_of_kernel
  ...
  obtain ⟨v, hv, happ⟩ :=
    pi.exists_unit_vector_approx_of_kernel psi hpsi hpure hker F hepsilon
